...
If incompleteness holds, there are simple models, like the ones I've discussed, where 1 is true, and all of 2, **Negative Pareto** and **Negative Dominance** are false.^[Even if you accept completeness, you might worry about 2 because of Arrow's impossibility results. A natural reading of those results is that the magnitude of the differences between people matters to the comparisons between worlds, not just the sign of the differences between people.] So if we antecedently accept incompleteness, we shouldn't think these arguments about how the value of complex objects like worlds or lotteries are grounded is a reason to reject it.
