...
Human Services, et al.} was a provision expanding Medicaid.\sidenote{\footnotesize 567
...
Photo by \href{https://www.flickr.com/photos/53283407@N04}{LaDawna
Howard} via
\href{https://search.creativecommons.org/photos/45c5c017-850b-4159-844b-1203fb8f6885}{Creative
Commons}.
...
minimum coverage requirements.\sidenote{\footnotesize Jonathan Engel, \emph{Poor
...
programs.\sidenote{\footnotesize \emph{NFIB v. Sebelius}, 567 U.S. \_\_\_, Ginsburg,
...
whose income is below 133\% of the federal poverty level.\sidenote{\footnotesize 42
...
states by the federal government.\sidenote{\footnotesize 42 U.S.C. 1396d(y)(1). More
...
claimants, the reimbursement rate is considerably lower.\sidenote{\footnotesize In
...
entitled to.\sidenote{\footnotesize 42 U.S.C. 1396c.}
...
years, without destroying its identity.\sidenote{\footnotesize \emph{NFIB v.
...
``accomplishes a shift in kind, not merely degree''.\sidenote{\footnotesize \emph{Id.},
...
United States.''\sidenote{\footnotesize U.S. Constitution, Article I, Section 8,
...
accordingly.\sidenote{\footnotesize \emph{NFIB v. Sebelius}, 567 U.S. \_\_\_,
...
objective.\sidenote{\footnotesize In our discussion, we'll leave open the question of
...
legislation has the nature of a contract.\sidenote{\footnotesize \emph{Id}., Roberts,
...
coercive; usually, it's simply voided.\sidenote{\footnotesize This is actually a
...
Sometimes they have to act like it.\sidenote{\footnotesize \emph{Id.}, Roberts, C.J.,
...
Clause.\sidenote{\footnotesize \emph{Id.} at 50.}
...
Act''.\sidenote{\footnotesize \emph{Id}.} To put the point another way, the
\emph{only} purpose of the bundling proposed by the ACA was to force the
states to participate in Expanded Medicaid.\sidenote{\footnotesize We'll talk
...
more than 10\% of the typical state's budget.\sidenote{\footnotesize In fiscal year
...
``economic dragooning''.\sidenote{\footnotesize \emph{NFIB v. Sebelius}, 567 U.S.
...
participate in a particular program.\sidenote{\footnotesize \emph{Id.} at 51.} And as
...
control on government spending.\sidenote{\footnotesize Note that Old Medicaid has
...
overturned.\sidenote{\footnotesize 483 U.S. 203 (1987).} That case concerned the
...
amount to unconstitutional coercion.\sidenote{\footnotesize \emph{NFIB v. Sebelius},
...
Ginsburg's.\sidenote{\footnotesize \emph{Id.}, Ginsburg, J., slip opin. at 39.} But
...
\item
  ...
  Medicaid).\sidenote{\footnotesize \emph{Id.}}
\end{enumerate}

We agree with J. Ginsburg that C.J. Roberts commits himself to the truth
of (4).\sidenote{\footnotesize \emph{Id.}, Roberts, C.J., slip opin. at 54. ``A State
...
either).\sidenote{\footnotesize The result of adding (4) to the Roberts Rule is
...
threatening the funds for the existing Medicaid program.''\sidenote{\footnotesize \emph{Id}.
...
states.\sidenote{\footnotesize \emph{Id}.} But we think that while J. Ginsburg does
...
defended by Caroline West).\sidenote{\footnotesize Caroline West, ``Personal Identity:
...
indeterminate identity.)\sidenote{\footnotesize Terrence Parsons, \emph{Indeterminate
...
Old Medicaid and then enacted New Medicaid as a replacement.\sidenote{\footnotesize \emph{NFIB
...
way?\sidenote{\footnotesize \emph{Id}.}
...
never marketed as such during Congressional debates.\sidenote{\footnotesize \emph{Id.},
...
they \emph{talk} about their powers.\sidenote{\footnotesize ``{[}T{]}he
...
dramatically''.\sidenote{\footnotesize \emph{Id.} at 53, 54.} Looking at what Congress
...
Medicaid to grow. That's roughly J. Ginsburg's position.\sidenote{\footnotesize \emph{Id.},
...
the first option is ruled out.\sidenote{\footnotesize For if ontology were
...
plausible one.\sidenote{\footnotesize As J. Ginsburg suggests, there's little doubt
...
under Expanded Medicaid.\sidenote{\footnotesize Kaiser Commission on Medicaid and the
...
tearing down?\sidenote{\footnotesize \emph{NFIB v. Sebelius}, 567 U.S. \_\_\_,
...
guns and refused the mutually beneficial deal.\sidenote{\footnotesize We are drawing
...
programs are not suitably related.\sidenote{\footnotesize \emph{Id.}, Roberts, C.J.,
...
responses.\sidenote{\footnotesize \emph{Id.}, Ginsburg, J., slip opin. at 50--51. J.
...
needy families with dependent children.''\sidenote{\footnotesize \emph{Id.}, Roberts,
...
to earn less than \$31,322 to qualify under this condition.\sidenote{\footnotesize U.S.
...
bizarre.\sidenote{\footnotesize J. Ginsburg makes a similar point. \emph{NFIB v.
...
threshold.\sidenote{\footnotesize Jared Bernstein, ``More Poverty than Meets the
...
Medicaid are more generous than those for Old Medicaid.\sidenote{\footnotesize See
...
Medicaid as it was at the time ACA was passed.\sidenote{\footnotesize \emph{NFIB v.
...
stone.\sidenote{\footnotesize See note 22.} They change, often substantially, from
...
C.J. Roberts\sidenote{\footnotesize \emph{Id}., Roberts, C.J., slip opin. at 52n12.}
and the authors of the Joint Dissent\sidenote{\footnotesize \emph{Id.}, Joint Dissent,
...
that that burden is in fact quite minor.\sidenote{\footnotesize See, for example,
...
otherwise spend on Medicaid between 2014 and 2022.\sidenote{\footnotesize Angeles,
...
ACA's Offer.\sidenote{\footnotesize Matthew Buttguens, Stan Dorn, and Caitlyn Carroll,
...
\emph{including} those with insurance.\sidenote{\footnotesize For an useful overview
...
available to the insured.\sidenote{\footnotesize In its first full year of
...
Cases?\sidenote{\footnotesize \emph{South Australia v Commonwealth} 65 CLR 373 (1942)
...
relationship can force changes to that relationship.\sidenote{\footnotesize Thanks to
