...
> *Bid 5*$\frac{1}{2}$ and have it accepted: In this case it gets the land (value 8) for 5$\frac{1}{2}$, net gain 2$\frac{1}{2}$.

> *Bid 5*$\frac{1}{2}$ and have it rejected: In this case B bids 6, and A accepts, so it gets 6.
