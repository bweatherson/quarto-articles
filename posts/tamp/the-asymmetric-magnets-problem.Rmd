...
First, we'll assume that the direction of a vector feature is an intrinsic feature of its bearer. We need a way to rigidly denote directions, so we'll call the direction that the vector in *A* points *d*~1~, and the direction that the vector in *B* points *d*~2~. Since *d*~1~ ${\neq}$ *d*~2~, *A* and *B* differ in their intrinsic properties. By the second clause of the Intrinsicness Principle, it follows that *A* and *B* are not duplicates.
