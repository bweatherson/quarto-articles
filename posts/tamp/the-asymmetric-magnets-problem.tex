...
\setstretch{1.1}
\lettrine{T}{here are many} controversial theses about intrinsicness and
duplication. The first aim of this paper is to introduce a puzzle that
shows that two of the \emph{uncontroversial} sounding ones can't both be
true. The second aim is to suggest that the best way out of the puzzle
requires sharpening some distinctions that are too frequently blurred,
...
\pandocbounded{\includegraphics[keepaspectratio]{images/amp_1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/amp_2.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/amp_3.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/amp_4.png}}
