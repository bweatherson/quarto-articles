...
gives him to get the deflationary conclusions.\sidenote{\footnotesize I'm grateful to
...
Kripke is presented here as the first of the moderns\sidenote{\footnotesize The first
...
philosophy.\sidenote{\footnotesize Just in case this gets misinterpreted, what I'm
...
\emph{allow}, and in doing so buy all end of trouble.\sidenote{\footnotesize It would
...
not how Ryle sees it.\sidenote{\footnotesize Of course he \emph{couldn't} have seen it
...
philosophical work.\sidenote{\footnotesize Thanks to David Chalmers, Michael Fara,
