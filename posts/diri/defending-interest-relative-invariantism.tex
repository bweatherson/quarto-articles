...
My preferred version of IRI has none of these three features.\sidenote{\footnotesize It
...
motivate interest-relativity\sidenote{\footnotesize Such as the Bank Cases in Stanley
...
interests, but one knows that \(p\) and the other does not.\sidenote{\footnotesize And
  this is true even though \(p\) is not a proposition about their
  interests, or something that is supported by propositions about their
  interests, and so on.} I happen to think that most of the general
...
conclude IRI is false.\sidenote{\footnotesize I will consider, and tentatively
  support, one principle stronger than IRI in the final section. But the
  key point is that these general principles are not needed to defend
  IRI.}
...
without drifting into skepticism.\sidenote{\footnotesize This points are expanded upon
...
expect, even collapses from a great height.\sidenote{\footnotesize In the West Gate
...
failure\sidenote{\footnotesize As I believe was the case in the I-35W collapse.}, but
...
them.\sidenote{\footnotesize See the massive drop in the numbers of students walking
...
for independent reasons.\sidenote{\footnotesize I think the objections I make here are
...
be knowledge-making.'' (\citeproc{ref-RussellDoris2008}{Russell and
Doris 2009, 432}).
...
2009, 433}) And this isn't just because wealth can purchase knowledge.
...
rather too direct.'' (\citeproc{ref-RussellDoris2008}{Russell and Doris
2009, 433})
...
his argument uses a variant of Stanley's Bank Cases.\sidenote{\footnotesize In the
...
know \(p\), Paul isn't.' (\citeproc{ref-MBT2009}{Blome-Tillmann 2009,
329n23})
\end{quote}
...
even though it is not a basic source.\sidenote{\footnotesize The caveats here about
...
Hawthorne and Jason Stanley have recently been defending.\sidenote{\footnotesize The
...
theory of medical ethics.\sidenote{\footnotesize I'm not saying that consequentialism
