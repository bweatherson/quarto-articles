...
Kripke (\citeproc{ref-Kripke1980}{{[}1972{]} 1980}) argued that what
determined the extension of a name or natural kind term need not be
known in order for a speaker to understand the expression, nor was it
what was contributed to the proposition expressed by a sentence
containing one. Each was suggesting that the roles attributed to a
single thing-the expression's meaning-in the {[}pre-theoretical{]}
picture, can be played by distinct things.
(\citeproc{ref-Russell2008}{Russell 2008} x)
\end{quote}
