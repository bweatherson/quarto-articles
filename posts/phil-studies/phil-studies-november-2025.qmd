...
Part of the evidence for that consists of which words were central to the journal in the 1980s. There was a lot of discussion in particular of Donnellan's distinction between referential and attributive uses of definite descriptions, and the words 'Donnellan', 'referential' and 'attributive' all appear frequently.

But while _Philosophical Studies_ was publishing a lot of philosophy of language at this time, it was not publishing the kind of philosophy of language that would become central to the next couple of decades. Ultimately, this is why the language articles it published in the 1980s and 1990s have relatively few citations. 

## 1990s {#sec-1990s-articles}

Like most other journals, there was a trend in the 1990s towards discussing two topics closely associated with the work of Jaegwon Kim: causation and supervenience. On the whole, I don't that either of these trends were more pronounced in _Philosophical Studies_ than elsewhere. The main lesson of @fig-causal and @fig-supervenience is that while there is the odd year when these words are used a lot in _Philosophical Studies_, usually just caused by one or two papers that use the word repeatedly, the trend here mostly matches the wider trends. I could present any number of cognates of these words, like 'causation' or 'supervenes' to make a similar point, but the shapes don't change much.

```{r}
#| output: asis

three_graphs("causal", 1990)
three_graphs("supervenience", 1990)
```

What is distinctive about _Philosophical Studies_ in the 1990s is that it keeps up a fascination with the debate between internalists and externalists about content, both linguistic and mental, after that had started fading from the other journals. Some of that is visible in words associated with prominent examples from these, such as @fig-Hesperus, @fig-Phosphorus, and @fig-arthritis.^[The discussion of 'arthritis' is of course mostly a response to @WOSA1986AYX3200001.]
...
Looking back, a lot of this discussion of content feels stale by the mid-1990s. There is a sense that the important things to say have been said. This shows up in the citation data. The _Philosophical Studies_ papers using these terms have a disproportionately high rate of citation in _Philosophical Studies_ itself. The rest of the field was moving on, but _Philosophical Studies_ was a step behind.
...
Despite the amount of work on language, and content more generally, in _Philosophical Studies_, what is more notable is perhaps what isn't there. I'll quickly go over three kinds of articles that rarely appear in _Philosophical Studies_ in the 1980s and 1990s: articles on conditionals; articles on speech acts; and interdisciplinary articles.

**CHECK THIS**:  Despite the prominence of philosophy of language before 2000, the words "conditional", "conditionals" and "counterfactuals" appear less frequently these decades than in later decades. There are no _Philosophical Studies_ articles cited in Dorothy Edgington's influential and comprehensive "On Conditionals" [@WOSA1995QX94800001].
