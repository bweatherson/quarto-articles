...
In @fig-1980s-words I show the frequency of some of the words mentioned in this subsection over time. I've put this in two graphs so the movement in the less frequently used words is easier to see. And as I will do in later sections, I've shaded the decade under discussion.
...
word_graphs_shaded(c("contextualism", "fictionalism", "physicalism"), 3, 2000)
word_graphs_shaded(c("contextualist", "fictionalist", "physicalist"), 3, 2000)
```
