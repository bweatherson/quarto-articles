...
1. Any essential property is an intrinsic feature.
...
Now consider any case where someone knows some propositions, and they properly infer some further proposition *p* from them. Call the resulting attitude towards *p* Fred. Since this is a proper inference from knowledge, I assume Fred is a bit of knowledge.
...
So putting all this together, we get that it is essential to Fred that it is knowledge, and indeed knowledge that *p*. It couldn't be knowledge of something else while being the kind of inference it was from the premises it was from. By 1, it is intrinsic to Fred that it is knowledge that *p*. From that it follows that *p* is true, and indeed that Fred meets all of the pre-requisites for knowledge. So inferential knowledge will be intrinsically determined on this picture, as required.
