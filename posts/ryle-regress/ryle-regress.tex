...
\ifPDFTeX\else  
  ...
  \setmainfont[ItalicFont=Cormorant Garamond Medium
Italic]{Garamond-Math}
...
be false.\sidenote{\footnotesize This argument is obviously rather quick, and I doubt
...
exchange.\sidenote{\footnotesize I thought this example was purely fictional, coming
...
from that list.\sidenote{\footnotesize Or, perhaps even more plausibly, coming up with
...
suggests these differences are diminishing.\sidenote{\footnotesize Thanks to Bernard
