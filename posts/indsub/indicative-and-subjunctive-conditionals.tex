...
As Kripke (\citeproc{ref-Kripke1980}{1980}) showed, the reference for
some terms is fixed by what plays a particular role in the actual world.
Even if it were the case that XYZ fills the ocean, falls from the sky,
is drinkable and transparent and so on, for short is \emph{watery}, it
would still be the case that water is H\textsubscript{2}O, not XYZ. For
it would still be that H\textsubscript{2}O \emph{actually} is watery.
Whatever were the case, this world would be actual.
