...
\begin{document}
\maketitle
Michael Strevens's book \emph{Depth} is a great achievement.\sidenote{\footnotesize All
...
Image from
\href{https://search.creativecommons.org/photos/503e66e1-0eb5-4ff4-9d8b-e3c6fee899c5}{Creative
Commons}.
...
problem.\sidenote{\footnotesize Strevens calls the problem of how to explain why (2)
...
encompasses even more events.\sidenote{\footnotesize For more on explanation as
...
On a busy suburban corner, there are four gas stations.\sidenote{\footnotesize `Petrol
...
on.\sidenote{\footnotesize Given the last point, we'd expect that after the BP
...
in question will usually not guarantee any outcome.\sidenote{\footnotesize For
...
dropping the time at which the eggs were bought.\sidenote{\footnotesize Of course, if
...
with no adjacent tract.\sidenote{\footnotesize There are a lot of technical details
...
beings play Nash equilibrium strategies.\sidenote{\footnotesize The normative claim
...
relative to that assumption.\sidenote{\footnotesize Note that maximising expected
...
generally play equilibrium strategies.\sidenote{\footnotesize Philosophers tend to
...
theorists.''\sidenote{\footnotesize The quote is from a blog post by Daniel Davies on
  October 8, 2010. See
...
sense needed for the kairetic theory.\sidenote{\footnotesize Actually, this sentence
...
economists are trying to explain.\sidenote{\footnotesize This might be reading too
  much into Strevens's discussion. What he says about a related example
  is that the existence of communicative channels within firms is part
  of the `framework' when making economic explanations. I don't know
  whether he would extend this story to cover all means by which firms
  get to equilibrium.}
