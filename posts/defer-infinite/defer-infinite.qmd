...
Let W be the reals in (0,1). E~1~(*x*) = [*x*,1), and E~2~(*x*) = (0,1). For any *x* in [0,1], let O~*x*~(*y*) be -1 if *x* \geq *y*, and *x* if *x* > *y*, and O be the set of all these O~*x*~. And Pr is the flat distribution over (0,1); the only fact I'll need is that whenever 0 < *x* < *y* < 1, the probability that the actual world is in (*x*, *y*) is *y* - *x*.
