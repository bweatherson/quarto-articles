...
\pandocbounded{\includegraphics[keepaspectratio]{apc_files/figure-pdf/fig-citationrateperyear-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{apc_files/figure-pdf/fig-nevercites-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{apc_files/figure-pdf/fig-percentuncited-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{apc_files/figure-pdf/fig-countofcitations-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{apc_files/figure-pdf/fig-countofcitationsout-1.pdf}}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.9187}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.0813}}@{}}
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.8993}}
  >{\raggedleft\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.1007}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
Article
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedleft
...
\pandocbounded{\includegraphics[keepaspectratio]{apc_files/figure-pdf/fig-ageeffectgrouped-1.pdf}}
