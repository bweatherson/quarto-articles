...
I'll go over the details of how to read diagrams like @fig-standard-newcomb in [insert cross-ref here!]. All you need to know for now is that the game starts at the open node, here at the top, and it moves along by 

 how to read diagrams like @fig-standard-newcomb in more de
Some of the conclusions that draw will be familiar: on one of the problems I’m going to defend a similar answer to what Melissa @Fuscond has defended; on another I'm going to defend a similar answer to one defended by Harvey @Ledermannd. What's primarily distinctive about the arguments here is that they show these questions are connected, and the arguments for my preferred answers are going to be intertwined.
