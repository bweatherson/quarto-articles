...
if(knitr::is_latex_output()) {
theme_update(plot.title = element_text(family = "Scala Sans Pro", size = 14, face = "bold"),
             plot.subtitle = element_text(family = "Scala Sans Pro", size = 11),
             axis.text = element_text(family = "Scala Sans Pro", size = 10),
             plot.background = element_rect(fill = "white"),
             panel.background = element_rect(fill = "white"),
             legend.background = element_rect(fill = "white"),
             panel.grid = element_line(color = "grey92"),
             legend.text = element_text(family = "Scala Sans Pro", size = 11),
             strip.text = element_text(family = "Scala Sans Pro", size = 12),
             legend.key.spacing.y = unit(0.5, 'lines'),
