...
It's not perfectly linear, but it's much closer than I would have guessed looking at how really quite non-linear the inputs are. @fig-cap-top-right shows the result of zooming in on a part of the graph to see this more vividly.
...
```{r}
#| label: tbl-diffk
#| caption: "The posterior probability after hearing two differentially informed experts."
master <- expand_grid(marked_ball = 0:1, 
