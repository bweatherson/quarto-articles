...
Unpublished draft. Thanks to audiences at Michigan, Toronto, and the
Arizona Philosophy Workshop for valuable feedback, not all of which I've
yet incorporated.
...
Picture by \href{https://www.flickr.com/photos/132936453@N08}{Andy
Warhol} via
\href{https://search.creativecommons.org/photos/a32cdda0-98f1-4d9a-a343-89b688df5c01}{Creative
Commons}.
...
from Bob Dylan (\citeproc{ref-Dylan2016}{2016}) 225)
\end{quote}
...
dollars.\sidenote{\footnotesize If that sounds implausible to you, make the
...
is going to look somewhat more promising\sidenote{\footnotesize Indeed, in early
  drafts of this paper, I didn't distinguish this proposal from the one
  I'll endorse in the next section. And those `early drafts' were
  circulated in late 2019. So they included the first draft of the paper
  that I sent to Ted. I'm sorry for doing something between clarifying
  and changing my view so late.}. Maybe we can't all at once choose the
...
realistic situations.\sidenote{\footnotesize This is very similar to the modal
...
under conditions of less than full information.\sidenote{\footnotesize At this point
  the Martians might note that while they are grateful that Williamson
...
but \(I^2(Q)\), and \(I^3(Q)\) and so on.\sidenote{\footnotesize At this point, some
  of the Martians note that the existence of Elster
