...
(\citeproc{ref-WOS:000070778500002}{1997})
...
\begin{longtable}[]{@{}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0496}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0455}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.9050}}@{}}
...
\bottomrule\noalign{}
\endlastfoot
33 & 9 & D Davidson (1990) ``The Structure and Content of Truth,''
...
\begin{longtable}[]{@{}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0916}}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.0840}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.8244}}@{}}
...
\includegraphics{citations-old-to-new_files/figure-pdf/fig-all-widely-cited-1.pdf}
...
\includegraphics{citations-old-to-new_files/figure-pdf/fig-all-median-unqualified-1.pdf}
...
\bottomrule\noalign{}
\endlastfoot
156 & S Haslanger (2000) ``Gender and Race: (What) Are They? (What) Do
...
\includegraphics{citations-old-to-new_files/figure-pdf/fig-four-five-recent-1.pdf}
...
\begin{longtable}[]{@{}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0641}}
...
\bottomrule\noalign{}
\endlastfoot
0 & HN Castañeda (1977) ``Perception, Belief, and Structure of Physical
...
\includegraphics{citations-old-to-new_files/figure-pdf/fig-three-recent-1.pdf}
...
\begin{longtable}[]{@{}
  >{\raggedleft\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.0815}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 2\tabcolsep) * \real{0.9185}}@{}}
...
\bottomrule\noalign{}
\endlastfoot
2 & N Block (1980) ``Are Absent Qualia Impossible,'' \emph{Philosophical
Review} 89~(2):~257-274. \\
...
\bibitem[\citeproctext]{ref-WOS:000070778500002}
