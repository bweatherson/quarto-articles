...
\pandocbounded{\includegraphics[keepaspectratio]{fourprob_files/figure-pdf/fig-standard-newcomb-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{fourprob_files/figure-pdf/fig-coin-then-demon-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{fourprob_files/figure-pdf/fig-demon-then-coin-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{fourprob_files/figure-pdf/fig-ultimatum-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{fourprob_files/figure-pdf/fig-sample-violation-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{fourprob_files/figure-pdf/fig-edt-1.pdf}}
...
to avoid information. Harvey
(\citeproc{ref-Ledermannd}{\textbf{Ledermannd?}}) argues that violations
of Ordering for utilities leads to violations of a principle he calls
Negative Dominance, which I'll return to below.
...
Harvey (\citeproc{ref-Ledermannd}{\textbf{Ledermannd?}}) notes that
given some other plausible assumptions, Ordering is inconsistent with a
principle he calls Negative Dominance.\footnote{Though note that, like
  Sen, Lederman raises doubts about these `other plausible assumptions'.
  Note also that I've rephrased his principle a little to match the
...
\pandocbounded{\includegraphics[keepaspectratio]{fourprob_files/figure-pdf/fig-redt-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{fourprob_files/figure-pdf/fig-buchak-1.pdf}}
