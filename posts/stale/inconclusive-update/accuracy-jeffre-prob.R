...
a_weight <- floor(runif(1)*5) # Best version: 2
b_weight <- floor(runif(1)*5) # Best version: 3
...
new_rat <- (floor(runif(1)*9)+1)/10 # Best version: 0.1
...
acc_tibb <- tibble(c = 450:550 * 0.001) |>
