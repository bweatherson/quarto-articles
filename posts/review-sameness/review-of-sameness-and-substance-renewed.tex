...
\href{https://ndpr.nd.edu/news/sameness-and-substance-renewed/}{Notre
...
\textbf{D}(i) (\emph{x})(\emph{t}) {[}(\emph{x} exists at \emph{t})~→
(∃\emph{g}) (\emph{g}(\emph{x})~at \emph{t}){]}.

\textbf{D}(ii) (\emph{x})(∃\emph{g})(\emph{t}) {[}(\emph{x} exists at
\emph{t})~→ (\emph{g}(\emph{x})~at \emph{t}){]}.
