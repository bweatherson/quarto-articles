...
And so if it is common knowledge that *T~R~* ⩽ *y*$, then it is best for Column to play *b* unless $x < \frac{2 + 4y}{5}$. That is, if it is common knowledge that *T~R~* ⩽ *y*$, then *T~C~* must be at most $\frac{2 + 4y}{5}$.
