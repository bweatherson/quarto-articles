...
What I'll call a _Stag Decision_ is basically a Stag Hunt game where the other player is a predictor. So the decision looks like @tbl-stag-decision, where the above four constraints on the values still hold, and **PX** means the predictor predicts **X** will be chosen.
