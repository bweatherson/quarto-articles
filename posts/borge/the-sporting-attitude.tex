...
this can't be the story\footnote{See the `Fistful of Fouls' example on
...
Borge discusses\footnote{See the ideas for how to flesh out a Suitsian
...
Borge's first argument\footnote{Again, I'm focussing on the discussion
...
games? As Borge points out, this would be an absurd result\footnote{I'm
