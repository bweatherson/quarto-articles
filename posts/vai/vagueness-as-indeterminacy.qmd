...
citation:
  type: chapter
  container-title: "Cuts and Clouds: Vagueness, its Nature, & its Logic"
  editor:
    - Richard Dietz
    - Sebastian Moruzzi
...
The letter of Patrick Greenough's proposal (to be discussed in @sec-greenough below) suggests that every vague term has only vague boundaries.
