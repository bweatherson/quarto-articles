...
experts each of whom our protagonist is disposed to defer to.\footnote{Important
  ...
  (\citeproc{ref-Zhang2025}{2026}), Dellsén
  (\citeproc{ref-Dellsen2020}{2020}) and Wright
  (\citeproc{ref-Wright2024}{2025}). The first two provide formal
...
The linear averaging version says that if Ava's credence is \emph{y},
...
\(\frac{\sqrt{yz}}{\sqrt{yz} + \sqrt{(1-y)(1-z)}}\).\footnote{I'm using
  a special case of the geometric averaging formula here. The general
...
\tightlist
\item
  \emph{Cr\textsubscript{Q}}(p~\textbar~\emph{Cr\textsubscript{A}}(\emph{p})~=~\emph{y}~∧~\emph{Cr\textsubscript{B}}(\emph{p})~=~\emph{z})
\end{enumerate}
...
and Ben say, are there heuristics for approximating the value of (6) in
...
\emph{Cr\textsubscript{Q}}(\emph{p}~\textbar~\emph{Cr\textsubscript{A}}(\emph{p})~=~\emph{y}~∧~\emph{Cr\textsubscript{B}}(\emph{p})~=~\emph{y})~=~\emph{y}.
...
\tightlist
\item
  \emph{Cr\textsubscript{Q}}(p~\textbar~\emph{Cr\textsubscript{A}}(\emph{p})~=~\emph{y}~∧~\emph{Cr\textsubscript{B}}(\emph{p})~=~\emph{z})~=~(\emph{yz}(1-\emph{r}))/(\emph{yz}(1-\emph{r})~+~(1-\emph{y})(1-\emph{z})\emph{r})
\end{enumerate}
...
propositions that would lead Ben to have credence \emph{x} in \emph{p},
...
\emph{Cr}(\emph{A\textsubscript{x}}~\textbar~¬\emph{p})~=~((1-\emph{x})\emph{r})/(\emph{x}(1-\emph{r}))\emph{Cr}(\emph{A\textsubscript{x}}
\textbar{} \emph{p}) this becomes:
...
model will help with more realistic cases.
...
\item
  ...
  \emph{k}, Quinn's credence should be 0.8\emph{k} + 32(1-\emph{k})/35.
  That is, it should be a weighted average of the first two, with the
  weight being the overlap in the evidence.
\end{enumerate}
...
because they observed something in them the other did not.\footnote{Compare
  ...
  (\citeproc{ref-HolmesAdventures}{Conan Doyle {[}1891{]} 2015}) about
  how many steps are in their lodgings. Holmes and Watson had access to
  the same staircase, but Holmes took in more evidence than Watson did.
  In that case it's not surprising which one got more evidence, but the
  same thing can happen in more symmetric relationships.} That's a
fairly plausible explanation of why they might come away from the same
...
Authority.''} \emph{Synthese} 198 (12): 12041--69.
\url{https://doi.org/10.1007/s11229-020-02849-z}.

\bibitem[\citeproctext]{ref-HolmesAdventures}
Conan Doyle, Arthur. (1891) 2015. \emph{The Adventures of Sherlock
Holmes}. Project Gutenberg.

\bibitem[\citeproctext]{ref-Dellsen2020}
Dellsén, Finnur. 2020. {``The Epistemic Value of Expert Autonomy.''}
\emph{Philosophy and Phenomenological Research} 100 (2): 344--61.
...
Cambridge University Press. \url{https://doi.org/10.1017/9781009315203}.
...
Computational and Graphical Statistics} 8 (3): 452--78.
...
Jackson, Frank. 1987. \emph{Conditionals}. Blackwell.

\bibitem[\citeproctext]{ref-Lane2025}
Lane, Devin. 2025. {``Should You Defer to Individual Experts?''}
\emph{Philosophy and Phenomenological Research} 111 (1): 216--34.
...
Science}. \url{https://doi.org/10.1086/727000}.
...
Wright, Jack. 2025. {``The Value of Independence Between Experts:
Epistemic Autonomy and Different Perspectives.''} \emph{Episteme} 22
(4): 818--34. \url{https://doi.org/10.1017/epi.2024.20}.

\bibitem[\citeproctext]{ref-Zhang2025}
Zhang, Snow. 2026. {``Coherent Combination of Multiple Experts'
Opinions: Another Impossibility Result.''} \emph{Theory and Decision}
100 (2): 451--78. \url{https://doi.org/10.1007/s11238-025-10092-6}.
