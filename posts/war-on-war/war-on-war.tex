...
\hypersetup{
  pdftitle={A Dynamic WAR on EDT},
  pdfauthor={Brian Weatherson},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{A Dynamic WAR on EDT}
...
where EDT predictably does worse than CDT.
\end{abstract}
...
This is what Lewis (\citeproc{ref-Lewis1981en}{1981c}) called the ``Why
...
\includegraphics{war-on-war_files/figure-pdf/fig-second-anti-war-1.png}
...
of the nine views I just described\footnote{Or possibly for an older
  ...
  (\citeproc{ref-Lewis1981b}{1981b}).}, but I can't see what
...
---------. 1981b. {``Causal Decision Theory.''} \emph{Australasian
...
---------. 1981c. {``Why Ain'cha Rich?''} \emph{No{û}s} 15 (3): 377--80.
