...
[^4]: @Weatherson2003 discusses what happens if we make P2$^*$ or P3$^*$ an axiom in place of either P2 and P3. It is argued there that this gives us too many functions to be useful in epistemology. The arguments in @Williamsms provide much stronger reasons for believing this conclusion is correct.
...
Finally, we let $m$ be a measure function defined over subsets of $W$. And for any sentence $S$ in $L$, $Pr(S)$ is $m(\{w: w \in V^*(S)\})$. @Weatherson2003 shows that any such $Pr$ is a $\vdash_{IL}$ probability function.
