...
Hong and Russell derive a contradiction from these four principles.
...
It's a bit more work, but a similar kind of argument shows that these premises also entail **Interpersonal Stochastic Compensation**, and hence can get to the same kind of contradiction.

More generally, we can get 