...
options.\footnote{The idea that humans can't distinguish similar options
  is important in (\citeproc{ref-Fechner1860}{\textbf{Fechner1860?}}).
  The earlier connection I've found to indifferent being intransitive is
  in Armstrong (\citeproc{ref-Armstrong1939}{1939}). Armstrong's example
  is rather confusing; the one I'll use here is based on Luce
  (\citeproc{ref-Luce1956}{1956}).} Assume that Chooser prefers more
...
(\citeproc{ref-LuceRaiffa1957}{\textbf{LuceRaiffa1957?}}).\footnote{I
  haven't found a case like this in Luce's sole-authored works, and
  indeed Debreu (\citeproc{ref-Debreu1960}{1960}) notes that a related
...
(i.e., ( \citeproc{ref-Tri}{\textbf{Tri?}})) is violated.
(\citeproc{ref-LuceRaiffa1957}{\textbf{LuceRaiffa1957?}})
\end{quote}
...
(\citeproc{ref-Sartre1948}{\textbf{Sartre1948?}}) has a famous example
...
(\citeproc{ref-Chang2024}{\textbf{Chang2024?}}) puts it, he chooses to
...
about semantics do not entail that.\footnote{I'm focussing here on the
  ...
  (\citeproc{ref-Broome1991}{\textbf{Broome1991?}}).}
...
\item
  ...
  current state.\footnote{This view of preference mirrors the view of
    credence defended by (\citeproc{ref-Carr2020}{\textbf{Carr2020?}}).}
\end{itemize}
