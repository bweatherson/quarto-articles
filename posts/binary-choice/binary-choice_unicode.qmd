...
The same options are choiceworthy from a union of two sets as are choiceworthy from the union of the choiceworthy members of those sets. This is a sort of independence of irrelevant alternatives principle; the availability or otherwise of nonchoiceworthy members of *S* and *T* doesn't affect what should be chosen from *S* ∪ *T*. 
...
What really motivates Lederman's examples is not negdom, but γ.
And we've seen lots of reasons to be sceptical of γ.
