...
\section{From Basel to Princeton}\label{from-basel-to-princeton}
...
principle:\sidenote{\footnotesize INDIFFERENCE entails C-INDIFFERENCE given the
...
take that gain, but as we heard your story she wasn't.\sidenote{\footnotesize Compare
...
Odysseus is in.\sidenote{\footnotesize Thanks to Jamie Dreier, Adam Elga and an
