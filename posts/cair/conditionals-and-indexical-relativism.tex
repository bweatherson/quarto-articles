...
of an utterance type is sensitive to context.\sidenote{\footnotesize It is actually a
...
supported by Stalnaker (\citeproc{ref-Stalnaker1981}{1981}). Denying
...
for the relation is morally worse than, in what follows.\sidenote{\footnotesize I
...
assessed, and C is the conditional relation\sidenote{\footnotesize I'm assuming
...
around this.\sidenote{\footnotesize The move I'm about to make bears at least a family
...
start of the section.\sidenote{\footnotesize I thought this was a way in which plural
...
did.''\sidenote{\footnotesize This response is similar to some of the arguments for
