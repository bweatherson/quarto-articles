...
\item[(2)]
If \(S\) knows that \(\varphi\) and \(\psi\) will produce the same
outcome if \(p\), and \(\varphi\) will produce a better outcome if
...
\(p\) could justify ignoring the fact that \(\psi\) does worse than
\(\varphi\) if \(\neg p\).
...
743--65. \url{https://doi.org/10.1080/09515089.2011.625118}.
...
Additivity.''} \emph{Philosophical Studies} 161 (3): 381--90.
\url{https://doi.org/10.1007/s11098-011-9744-z}.
