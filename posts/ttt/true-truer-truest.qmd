...
|    
|     \noindent *V*(*A* ∧ *B*) = min(*V*(*A*), *V*(*B*))
|     *V*(*A* ∨ *B*) = max(*V*(*A*), *V*(*B*))
|     *V*(*A* → *B*) = max(1, 1 - *V*(*A*) + *V*(*B*))
|           *V*(¬*A*) = 1 - V(*A*)
|    

\noindent where *V* is the valuation function on sentences, min(*x*, *y*) is the smaller of *y* and *y* and max(*x*, *y*) is the larger of *y* and *y*.
