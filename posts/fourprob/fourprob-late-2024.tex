...
\includegraphics{fourprob-late-2024_files/figure-pdf/fig-ace-king-1.pdf}
...
\includegraphics{fourprob-late-2024_files/figure-pdf/fig-newcomb-1.pdf}
...
\includegraphics{fourprob-late-2024_files/figure-pdf/fig-main-example-1.pdf}
...
SCP.\footnote{In my experience game theory texts don't get as far as
  equilibrium selection theories a la
  (\citeproc{ref-HarsanyiSelten1987}{\textbf{HarsanyiSelten1987?}}). If
  they do, that would be the first point where a solution concept
  violating SCP is introduced.}
...
\includegraphics{fourprob-late-2024_files/figure-pdf/fig-buchak-1.pdf}
...
settle which options are choice-worthy. This assumption isn't
universally shared, but it is very widely shared. Indeed, it is common
in philosophy papers to specify nothing but these values and then ask
for intuitions about the case, which suggests many people do presuppose
that only these values are necessary to determine what is choice-worthy.
Call this assumption \textbf{Settling}, because the values (i.e., the
payouts and the conditional probability of correct payouts) settle what
is choice-worthy.
...
\includegraphics{fourprob-late-2024_files/figure-pdf/fig-two-good-1.pdf}
...
\includegraphics{fourprob-late-2024_files/figure-pdf/fig-beta-1.pdf}
...
\includegraphics{fourprob-late-2024_files/figure-pdf/fig-chooser-guy-two-1.pdf}
