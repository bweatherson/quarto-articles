...
Since \textbf{First Day} entails (1) , and \textbf{Last Day} entails
(3), these principles entail the ⅓~answer. But they don't settle what to
say about the Three-Day Sleeping Beauty example. If
...
~~~\emph{Cr}\textsubscript{3}(Today is Monday and Heads) =
\(\nicefrac{1}{5}\)~\\
\strut ~~~\emph{Cr}\textsubscript{3}(Today is Monday and Tails) =
\(\nicefrac{1}{5}\)~\\
\strut ~~~\emph{Cr}\textsubscript{3}(Today is Tuesday and Tails) =
\(\nicefrac{2}{5}\)~\\
\strut ~~~\emph{Cr}\textsubscript{3}(Today is Wednesday and Tails) =
\(\nicefrac{1}{5}\)~
...
~~~\emph{Cr}\textsubscript{0}(\emph{h}\textsubscript{1}) =
\emph{Cr}\textsubscript{0}(\emph{h}\textsubscript{1} ∧
\emph{p}\textsubscript{11})\\
\strut ~~~\emph{Cr}\textsubscript{0}(\emph{h}\textsubscript{1}) =
\emph{Ch}(\emph{h}\textsubscript{1})
