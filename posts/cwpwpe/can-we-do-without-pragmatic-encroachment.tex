...
primary.\sidenote{\footnotesize To say the agent prefers A to B given \(q\) is not to
...
matter.\sidenote{\footnotesize This might seem \emph{much} too simple, especially when
...
\emph{unconditional} preferences over live, salient options.\sidenote{\footnotesize Conditionalising
...
0.9 to the proposition \emph{That train is a local}.\sidenote{\footnotesize I think
...
epistemic concepts are themselves pragmatically sensitive.\sidenote{\footnotesize Thanks
