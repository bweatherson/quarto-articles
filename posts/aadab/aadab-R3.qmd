...
And the last line contradicts **Possible Dependence**. So not all six of these assumptions can be correct, if DAB is true. Since Lewis thinks they are all correct, he concludes DAB is false.
...
Auntie E is an evidential decision theorist. For her, the value of an arbitrary descriptive proposition A is given by **Auntie E's Value**.
