...
The fifth argument is that only with this constraint added can players do well in certain kinds of decision problems that, intuitively, rational players can do well in. The following example is taken (with very minor modifications) from @Stalnaker1999 [317], who in turn takes it from @Rub199. 
