...
The significance of this claim can be illustrated by considering a canonical money-pump argument against incomplete preferences, often called the ``Single Souring Moneypump'' (Chang%The Chang piece is online at https://philpapers.org/archive/CHAIIA-2.pdf. In a footnote she suggests some sympathy with resolute choice responses to it
...
\node[circle, draw] {}
    child {
        node[circle, draw] {}
        child {
            node[circle, fill, inner sep=1.5pt, label=right:{$B$}] {}
            edge from parent
            node[above] {}
        }
        child {
            node[circle, fill, inner sep=1.5pt, label=right:{$A-$}] {}
            edge from parent
            node[below] {}
        }
        edge from parent
